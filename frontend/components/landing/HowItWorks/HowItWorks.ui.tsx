        ...
        <section id="how-it-works" className="relative py-24 lg:py-32 bg-gray-50 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 text-center">
                    <button className="btn-primary inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-primary-light px-8 py-4 text-lg font-semibold text-white shadow-xl shadow-primary/25 transition-all hover:shadow-2xl hover:shadow-primary/30 hover:scale-105">
