        ...
        <section className="relative min-h-screen overflow-hidden bg-gradient-to-b from-blue-50 via-white to-white">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32">
                <div className="text-center">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-2 mb-8 animate-fade-in-up">
                    ...
                    {/* Main Headline */}
                    <h1 className="mx-auto max-w-5xl text-5xl font-extrabold tracking-tight text-dark sm:text-6xl lg:text-7xl xl:text-8xl animate-fade-in-up delay-100">
                        Your content,{" "}
                    ...
                    {/* Subheadline */}
                    <p className="mx-auto mt-8 max-w-2xl text-xl text-text-muted lg:text-2xl animate-fade-in-up delay-200">
                    ...
                    <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-in-up delay-300">
                        <button className="btn-primary group flex items-center gap-2 rounded-full bg-gradient-to-r from-primary to-primary-light px-8 py-4 text-lg font-semibold text-white shadow-xl shadow-primary/25 transition-all hover:shadow-2xl hover:shadow-primary/30 hover:scale-105">
                            {heroContent.ctaText}
